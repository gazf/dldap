...
function desEncrypt(block: Uint8Array, key8: Uint8Array): Uint8Array {
  ...
  for (let r = 0; r < 16; r++) {
    ...
    cd[0] = (C >>> 20) & 0xff; cd[1] = (C >>> 12) & 0xff;
    cd[2] = (C >>> 4) & 0xff;  cd[3] = ((C & 0xf) << 4) | ((D >>> 24) & 0xf);
  ...
  for (let r = 0; r < 16; r++) {
    ...
    fBytes[0] = (fVal >>> 24) & 0xff; fBytes[1] = (fVal >>> 16) & 0xff;
    fBytes[2] = (fVal >>> 8) & 0xff;  fBytes[3] = fVal & 0xff;
